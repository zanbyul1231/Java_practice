...
public class Test01 {
    public static void main(String[] args) {
        ...
        double averageScore = students.stream()
            .filter(s -> "Computer Science".equals(s.getMajor()))  //Stream<Student>
            .mapToDouble(Student::getScore) //Stream<Double>
            .average() //평균  OptionalDouble
            .getAsDouble();
            //.orElse(0.0);

        System.out.println("Computer Science 전공 평균 점수: " + averageScore);
    }
}
